...
generateInput("input1.txt", floors=5, capacity=4, totalRequests=10)
generateInput("input2.txt", floors=15, capacity=6, totalRequests=30)
generateInput("input3.txt", floors=30, capacity=8, totalRequests=60)